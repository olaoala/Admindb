...
import ColumnChart from '../layouts/Chart';
      ...
      <Container fluid>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Amount Paid</p>
                      <Card.Title as="h5">₦23,000,000</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Amount Due</p>
                      <Card.Title as="h5">₦3,000,000</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
        ...
        <Row>
          <Col md="8">
            <Card>
              <Card.Header>
                <Card.Title as="h5">Activity Performance</Card.Title>
              </Card.Header>
              <Card.Body>
                <div className='' id="">
                <ColumnChart data={salesData} height={235} width={550} />
                </div>
              </Card.Body>
          ...
          <Col md="4">
            <Card>
              <Card.Header>
                <Card.Title as="h5">Highest Selling Project</Card.Title>
